...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        //  Coinbase(hash=12630d16a9, nTime=1516965438, ver=1, vin.size=1, vout.size=1, nLockTime=0)
        ...
        const char* pszTimestamp = "Euronews Ariane alert as contact lost";
        CTransaction txNew;
        txNew.nTime = 1516965438;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1516965438;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 15972 : 15972;
        ...
        assert(block.hashMerkleRoot == uint256("0xe464f9cd8106580ead7ecf593dce58bad2d3d639608696b3e223560eb413ecc2"));
...
unsigned char pchMessageStart[4] = { 0xb9, 0x4c, 0x47, 0xa1 };
